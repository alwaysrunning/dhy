...
define(function (require, exports, module){
  ...
  var Picker = function (params) {
      ...
      if (p.params.input) {
          ...
          if (p.input.length > 0) {
              ...
              if (!p.inline) {
                  p.input.on('tap', openOnInput); //click tap iScroll内click无效
              }
      ...
      if (!p.inline) $('html').on('tap', closeOnHTMLClick);
  ...
  $("body").off().on("click", ".close-picker", function() {
