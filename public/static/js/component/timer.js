 ...
 * @version 1.2
 * 修改后支持zepto @author ricopter@qq.com
...
define(function (require, exports, module){
    ...
    $.timer={
        ...
        add: function (element, interval, label, fn, times) {
            ...
            var timers=$.tmp[element[0].tagName]?$.tmp[element[0].tagName]:$.tmp[element[0].tagName]={};
            console.log(element,label,$.tmp[element[0].tagName],timers,timers[label]);
        ...
        remove: function (element, label, fn) {
            var timers = $.tmp[element[0].tagName], ret;
            if (timers) {
